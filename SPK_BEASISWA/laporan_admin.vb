...
Public Class laporan_admin
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPK_BEASISWA.laporan_admin.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_admin
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_admin = New laporan_admin()
        rpt.Site = Me.Site
        Return rpt
    End Function
