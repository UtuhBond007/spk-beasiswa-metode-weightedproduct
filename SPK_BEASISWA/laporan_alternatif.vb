...
Public Class laporan_alternatif
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPK_BEASISWA.laporan_alternatif.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_alternatif
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_alternatif = New laporan_alternatif()
        rpt.Site = Me.Site
        Return rpt
    End Function
