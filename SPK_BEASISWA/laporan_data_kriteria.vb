...
Public Class laporan_data_kriteria
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "laporan_data_kriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPK_BEASISWA.laporan_data_kriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_data_kriteria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_data_kriteria = New laporan_data_kriteria()
        rpt.Site = Me.Site
        Return rpt
    End Function
