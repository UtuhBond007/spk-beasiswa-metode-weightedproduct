...
Public Class laporan_data_siswa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPK_BEASISWA.laporan_data_siswa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_data_siswa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_data_siswa = New laporan_data_siswa()
        rpt.Site = Me.Site
        Return rpt
    End Function
