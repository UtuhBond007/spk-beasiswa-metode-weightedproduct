...
Public Class laporan_kriteria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SPK_BEASISWA.laporan_kriteria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlaporan_kriteria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As laporan_kriteria = New laporan_kriteria()
        rpt.Site = Me.Site
        Return rpt
    End Function
